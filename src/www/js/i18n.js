...
const messages = { // eslint-disable-line no-unused-vars
  en: {
    ...
    expiryHours: 'h.',
    expiryMinutes: 'min.',
    expiryTitle: 'Extend expiry',
    expiryFrom: 'Add from now:',
    expiryReset: '⛔ Reset time',
    expiryPermanent: '∞ Make permanent',
  ...
  ua: {
    ...
    expiryLabel: 'Термін дії (необов\'язково):',
    expiryDays: 'д.',
    expiryHours: 'г.',
    expiryMinutes: 'хв.',
    expiryTitle: 'Продовжити термін',
    expiryFrom: 'Додати від зараз:',
    expiryReset: '⛔ Скинути час',
    expiryPermanent: '∞ Зробити безстроковим',
    expiryUnlimited: 'Безстроково',
    expiryExpired: 'Термін вийшов',
  },
  ru: {
    name: 'Имя',
    password: 'Пароль',
    ...
    expiryHours: 'ч.',
    expiryMinutes: 'мин.',
    expiryTitle: 'Продлить срок',
    expiryFrom: 'Добавить от сейчас:',
    expiryReset: '⛔ Сбросить время',
    expiryPermanent: '∞ Сделать бессрочным',
    expiryUnlimited: 'Бессрочно',
    expiryExpired: 'Истёк',
  },
  tr: { // Müslüm Barış Korkmazer @babico
    ...
    expiryLabel: 'Son kullanma (isteğe bağlı):',
    expiryDays: 'g.',
    expiryHours: 's.',
    expiryMinutes: 'dk.',
    expiryTitle: 'Süreyi uzat',
    expiryFrom: 'Şu andan itibaren ekle:',
    expiryReset: '⛔ Süreyi sıfırla',
    expiryPermanent: '∞ Süresiz yap',
    expiryUnlimited: 'Süresiz',
    expiryExpired: 'Süresi doldu',
  },
  no: { // github.com/digvalley
    ...
    madeBy: 'Laget av',
    donate: 'Doner',
    expiryLabel: 'Utløp (valgfritt):',
    expiryDays: 'd.',
    expiryHours: 't.',
    expiryMinutes: 'min.',
    expiryTitle: 'Forleng utløp',
    expiryFrom: 'Legg til fra nå:',
    expiryReset: '⛔ Tilbakestill tid',
    expiryPermanent: '∞ Gjør permanent',
    expiryUnlimited: 'Ubegrenset',
    expiryExpired: 'Utløpt',
  },
  pl: { // github.com/archont94
    ...
    expiryLabel: 'Wygaśnięcie (opcjonalne):',
    expiryDays: 'd.',
    expiryHours: 'g.',
    expiryMinutes: 'min.',
    expiryTitle: 'Przedłuż ważność',
    expiryFrom: 'Dodaj od teraz:',
    expiryReset: '⛔ Resetuj czas',
    expiryPermanent: '∞ Ustaw bezterminowo',
    expiryUnlimited: 'Bezterminowo',
    expiryExpired: 'Wygasło',
  },
  fr: { // github.com/clem3109
    ...
    expiryHours: 'h.',
    expiryMinutes: 'min.',
    expiryTitle: 'Prolonger l\'expiration',
    expiryFrom: 'Ajouter depuis maintenant :',
    expiryReset: '⛔ Réinitialiser',
    expiryPermanent: '∞ Rendre permanent',
    expiryUnlimited: 'Illimité',
  ...
  de: { // github.com/florian-asche
    ...
    expiryLabel: 'Ablauf (optional):',
    expiryDays: 'T.',
    expiryHours: 'Std.',
    expiryMinutes: 'Min.',
    expiryTitle: 'Ablauf verlängern',
    expiryFrom: 'Ab jetzt hinzufügen:',
    expiryReset: '⛔ Zeit zurücksetzen',
    expiryPermanent: '∞ Unbegrenzt machen',
  ...
  ca: { // github.com/guillembonet
    ...
    madeBy: 'Fet per',
    donate: 'Donatiu',
    expiryLabel: 'Caducitat (opcional):',
    expiryDays: 'd.',
    expiryHours: 'h.',
    expiryMinutes: 'min.',
    expiryTitle: 'Ampliar caducitat',
    expiryFrom: 'Afegir des d\'ara:',
    expiryReset: '⛔ Restablir temps',
    expiryPermanent: '∞ Fer permanent',
    expiryUnlimited: 'Il·limitat',
    expiryExpired: 'Caducat',
  },
  es: { // github.com/amarqz
    ...
    expiryLabel: 'Caducidad (opcional):',
    expiryDays: 'd.',
    expiryHours: 'h.',
    expiryMinutes: 'min.',
    expiryTitle: 'Ampliar caducidad',
    expiryFrom: 'Añadir desde ahora:',
    expiryReset: '⛔ Restablecer tiempo',
    expiryPermanent: '∞ Hacer permanente',
    expiryUnlimited: 'Ilimitado',
  ...
  vi: {
    ...
    madeBy: 'Được tạo bởi',
    donate: 'Ủng hộ',
    expiryLabel: 'Hết hạn (tùy chọn):',
    expiryDays: 'ng.',
    expiryHours: 'g.',
    expiryMinutes: 'ph.',
    expiryTitle: 'Gia hạn',
    expiryFrom: 'Thêm từ bây giờ:',
    expiryReset: '⛔ Đặt lại thời gian',
    expiryPermanent: '∞ Vĩnh viễn',
    expiryUnlimited: 'Vĩnh viễn',
  ...
  nl: {
    ...
    expiryHours: 'u.',
    expiryMinutes: 'min.',
    expiryTitle: 'Vervaldatum verlengen',
    expiryFrom: 'Toevoegen vanaf nu:',
    expiryReset: '⛔ Tijd resetten',
    expiryPermanent: '∞ Permanent maken',
    expiryUnlimited: 'Onbeperkt',
    expiryExpired: 'Verlopen',
  },
  is: {
    name: 'Nafn',
    password: 'Lykilorð',
    ...
    madeBy: 'Gert af',
    donate: 'Gefa',
    expiryLabel: 'Gildistími (valfrjálst):',
    expiryDays: 'd.',
    expiryHours: 'klst.',
    expiryMinutes: 'mín.',
    expiryTitle: 'Framlengja gildistíma',
    expiryFrom: 'Bæta við frá núna:',
    expiryReset: '⛔ Endurstilla tíma',
    expiryPermanent: '∞ Gera varanlegt',
    expiryUnlimited: 'Ótakmarkað',
    expiryExpired: 'Útrunnið',
  },
  pt: {
    name: 'Nome',
    ...
    madeBy: 'Feito por',
    donate: 'Doar',
    expiryLabel: 'Expiração (opcional):',
    expiryDays: 'd.',
    expiryHours: 'h.',
    expiryMinutes: 'min.',
    expiryTitle: 'Prolongar expiração',
    expiryFrom: 'Adicionar a partir de agora:',
    expiryReset: '⛔ Redefinir tempo',
    expiryPermanent: '∞ Tornar permanente',
    expiryUnlimited: 'Ilimitado',
    expiryExpired: 'Expirado',
  },
  chs: {
  ...
  it: {
    ...
    expiryHours: 'h.',
    expiryMinutes: 'min.',
    expiryTitle: 'Estendi scadenza',
    expiryFrom: 'Aggiungi da adesso:',
    expiryReset: '⛔ Azzera tempo',
    expiryPermanent: '∞ Rendi permanente',
    expiryUnlimited: 'Illimitato',
    expiryExpired: 'Scaduto',
  },
  th: {
    name: 'ชื่อ',
    password: 'รหัสผ่าน',
    ...
    madeBy: 'สร้างโดย',
    donate: 'บริจาค',
    expiryLabel: 'วันหมดอายุ (ไม่บังคับ):',
    expiryDays: 'ว.',
    expiryHours: 'ช.',
    expiryMinutes: 'น.',
    expiryTitle: 'ต่ออายุ',
    expiryFrom: 'เพิ่มจากตอนนี้:',
    expiryReset: '⛔ รีเซ็ตเวลา',
    expiryPermanent: '∞ ตั้งถาวร',
    expiryUnlimited: 'ไม่จำกัด',
    expiryExpired: 'หมดอายุ',
  },
  hi: { // github.com/rahilarious
    ...
    madeBy: 'सर्जक',
    donate: 'दान करें',
    expiryLabel: 'समाप्ति (वैकल्पिक):',
    expiryDays: 'दि.',
    expiryHours: 'घं.',
    expiryMinutes: 'मि.',
    expiryTitle: 'समय बढ़ाएं',
    expiryFrom: 'अभी से जोड़ें:',
    expiryReset: '⛔ समय रीसेट',
    expiryPermanent: '∞ स्थायी करें',
    expiryUnlimited: 'असीमित',
